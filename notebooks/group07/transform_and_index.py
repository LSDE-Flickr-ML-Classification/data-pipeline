...
print("Unclassified images in final output: {0}".format(unclassified_label_df.count()))
  ...
  for file in chunk:
    ...
    while retries < 3:  
      try:
        ...
        retries += 1
      if retries == 3:
        raise Exception("Failed adding: {0}".format(file.path)) 
