...
BUCKET_NUM = getArgument("BUCKET_NUM", "0")
INPUT_PARQUET = "/dbfs/mnt/group07/final_data_product/downloaded_images-{0}.parquet".format(BUCKET_NUM)
# Retry dataset
INPUT_PARQUET = "/dbfs/mnt/group07/final_data_product/downloaded_images-retry-final_v2.parquet"
...
def process_partition(partition, output_folder, model, CLASSES, DEVICE):
  ...
  for df in parquet_file.iter_row_groups(columns=["id", "img_binary"]):
